...
export const OPPORTUNITIES_ROUTES: Route[] = [
  ...
  // DETAILS
  {
    ...
    children: [
      {
        path: '',
        loadComponent: () => import('./components/details/components/main/main.component').then(m => m.MainComponent),
      },
      {
        path: WEB_ROUTES.OPPORTUNITIES.PAYMENT,
        loadComponent: () =>
          import('./components/details/components/payment/payment.component').then(m => m.PaymentComponent),
