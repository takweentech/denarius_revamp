...
export class ProfileService {
  ...
  getUserProfile(): Observable<HttpCustomResponse<UserProfileData>> {
    return this.http.get<HttpCustomResponse<UserProfileData>>(
      `${environment.apiUrl}/${this.baseUrl}/GetMainProfile`
    );
  }
  ...
  getInvestmentStatistics(): Observable<
    HttpCustomResponse<UserInvestmentStatisticsData>
  > {
  ...
  getBasicPersonalInformation(): Observable<
    HttpCustomResponse<UserBasicProfileData>
  > {
  ...
  getBankInformation(): Observable<HttpCustomResponse<UserBankData>> {
    return this.http.get<HttpCustomResponse<UserBankData>>(
      `${environment.apiUrl}/${this.baseUrl}/GetBankInformation`
    );
  }

  saveBankInformation(
    payload: UserBankData
  ): Observable<HttpCustomResponse<UserBankData>> {
  ...
  getInvestmentInformation(): Observable<
    HttpCustomResponse<UserInvestmentData>
  > {
  ...
  getImageProfile(): Observable<HttpCustomResponse<string>> {
    return this.http.get<HttpCustomResponse<string>>(
      `${environment.apiUrl}/${this.baseUrl}/GetImageProfile`
    );
  }
  setImageProfile(path: string): Observable<HttpCustomResponse<{}>> {
    return this.http.post<HttpCustomResponse<{}>>(
      `${environment.apiUrl}/${
        this.baseUrl
      }/SetImageProfile?path=${encodeURIComponent(path)}`,
      {}
    );
  }
}
