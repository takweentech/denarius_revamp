...
export class UpgradeService {
  ...
  create(payload: FormData): Observable<HttpCustomResponse<{}>> {
    return this.http.post<HttpCustomResponse<{}>>(
      `${environment.apiUrl}/${this.baseUrl}/AddUpgradeRequest`,
      payload
    );
  }
  ...
  getAll(): Observable<HttpCustomResponse<UpgradeRequest[]>> {
    return this.http.get<HttpCustomResponse<UpgradeRequest[]>>(
      `${environment.apiUrl}/${this.baseUrl}/GetAll`
    );
  }

  getPaged(
    filter?: UpgradeRequestFilter
  ): Observable<HttpCustomResponse<HttpPagedResponse<UpgradeRequest[]>>> {
    return this.http.post<
      HttpCustomResponse<HttpPagedResponse<UpgradeRequest[]>>
    >(`${environment.apiUrl}/${this.baseUrl}/GetPaged`, filter);
  }
  ...
  downloadUpgradeFile(requestId: number, fileName: string): Observable<Blob> {
    const params = {
    ...
    return this.http.get(
      `${environment.apiUrl}/${this.baseUrl}/DownloadUpgradeFile`,
      {
        params,
        responseType: "blob", // Important: This ensures you receive a file
      }
    );
  }
}
